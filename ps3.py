...
class RectangularRoom(object):
    ...
    def __init__(self, width, height, dirt_amount):
        ...
        except(width<=0 or height<=0 or dirt_amount<0):
...
class Robot(object):
    ...
    def set_robot_position(self, position):
        ...
        try:
            self.pos=position
        except(not type(self.pos) is Position):    
            raise NotImplementedError
    ...
    def set_robot_direction(self, direction):
        ...
        except(self.direction<0 or self.direction>360):
            raise NotImplementedError
...
class EmptyRoom(RectangularRoom):
    ...
    def get_random_position(self):
        ...
        """
        pos1=Position(random.randint(0,self.width-1)+random.random(),random.randint(0,self.height-1)+random.random())
        return pos1
...
class FurnishedRoom(RectangularRoom):
    ...
    def get_num_tiles(self):
        ...
        try:
            ...
            for i in range(self.width):
                for j in range(self.height):
                    if not self.is_tile_furnished(i,j):
                        count+=1
            return count
        except:    
            raise NotImplementedError
    ...
    def get_random_position(self):
        ...
        try:
            ...
            for i in range(self.width):
                for j in range(self.height):
                    if not self.is_tile_furnished(i,j):  
                        tile_free.append((i,j))
            tile_random=random.choice(tile_free)
            pos1=Position(tile_random[0]+random.random(),tile_random[1]+random.random())
            return pos1
        except:
            raise NotImplementedError
...
class StandardRobot(Robot):
    ...
    def update_position_and_clean(self):
        ...
        """
        pos_temp=self.get_robot_position().get_new_position(self.direction,self.speed)
        if (self.room.is_position_valid(pos_temp)):
            self.set_robot_position(pos_temp)
...
def run_simulation(num_robots, speed, capacity, width, height, dirt_amount, min_coverage, num_trials,
    ...
    robot_type: class of robot to be instantiated (e.g. StandardRobot or
                FaultyRobot)
    """
#    if (num_robots<=0 or speed <=0 or capacity<=0 or width<=0 or height<=0 or \
#        min_coverage<0 or min_coverage>1 or num_trials <=0 or isinstance(num_robots,int) or isinstance(speed,float)\
#        or isinstance(capacity,int) or isinstance(width,int) or isinstance(height,int)or isinstance(dirt_amount,int)):
#        raise NotImplementedError
    count=0
...
def show_plot_room_shape(title, x_label, y_label):
    ...
    for width in [10, 20, 25, 50]:
        ...
        times1.append(run_simulation(2, 1.0, 1, int(width), int(height), 3, 0.8, 200, StandardRobot))
        times2.append(run_simulation(2, 1.0, 1, int(width), int(height), 3, 0.8, 200, FaultyRobot))
